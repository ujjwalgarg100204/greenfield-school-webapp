                  ...
                  <tr>
                    ...
                    <div className="my-7  w-full border-3 ">
                        ...
                        <div className=" py-4 ">
                            <table className=" w-fit table-auto border-separate text-xs md:border-spacing-4  md:text-lg ">
                                ...
                                <tbody className="text-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                className="w-fit border-2 text-center "
                                                type="text"
                                                value={formattedDate}
                                                readOnly
                            ...
                            <table className="w-full table-auto border-separate border border-black text-xs md:border-spacing-2  md:text-lg">
                                <tbody className="w-fit  ">
                                    ...
                                    <tr>
                                        <th>
                                            <h4 className="md:text-medium">
                                                School Fee
                                            </h4>
                                            <span className="md:text-xs">
                                                Balance :
                                            </span>
                                            <span className="text-red-500 md:text-xs">
                                                ₹10
                                            </span>
                                        </th>
                                        <td>
                                            <input
                                                className="w-full border-2 bg-slate-100 text-center "
                                                type="text"
                                                placeholder="₹0"
                                                {...register(
                                                    "school_fee_amount_paid",
                                                    {
                                                        required: true,
                                                    },
                                                )}
                                            />
                                            {errors.school_fee_amount_paid &&
                                                errors.school_fee_amount_paid
                                                    .type === "required" && (
                                                    <p className="text-xs text-danger-500 md:text-sm">
