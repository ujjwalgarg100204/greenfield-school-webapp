...
import { SelectecdAcademicYrCtxProvider } from "./_contexts/SelectedAcademicYrCtx";
import { AllAcademicYrCtxProvider } from "./_contexts/AllAcademicYrCtx";
...
const DashboardLayout: FC<Props> = async ({ children }) => {
    ...
    return (
        <AllAcademicYrCtxProvider>
            <SelectecdAcademicYrCtxProvider>
                <div className="flex min-h-screen flex-col">
                    ...
                    <div className="flex flex-grow gap-4">{children}</div>
                </div>
            </SelectecdAcademicYrCtxProvider>
        </AllAcademicYrCtxProvider>
    );
