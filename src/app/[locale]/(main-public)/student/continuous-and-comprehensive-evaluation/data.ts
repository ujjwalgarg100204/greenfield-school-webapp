  ...
  "IX-X": [
    {
      assessmentType: "Formative Assessments",
      assessmentName: "FA1 (April – June)",
      evaluationBasis: "Written Assessment, Activities, Practicals, CW / HW",
      term: "1st Term",
      weightage: "10%",
    },
    {
    ...
    },
    {
      ...
      assessmentName: "FA4 (Jan-Feb)",
      term: "2nd Term",
      evaluationBasis: "Written Assessment (2nd Lang) PSA for other subject",
      weightage: "10%",
    },
    {
      assessmentType: "Summative Assessments",
...
export const subjectViseHomeworkActivityEvaluationPlan = [
  ...
  },
  {
    ...
    work: ["Knowledge of the present economic situation", "Application Skill"],
