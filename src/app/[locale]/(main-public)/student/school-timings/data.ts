export default {
  senior: {
    reporting: [
      { "means-of-transport": "Private Cars/Conveyance", timings: "7:15 a.m." },
      { "means-of-transport": "School Bus", timings: "7:25 a.m." },
    ],
    dispersal: [
      { classes: "II - V", timings: "1:00 p.m." },
      { classes: "VI - X", timings: "1:40 p.m." },
      { classes: "XI - XII (Commerce & Humanities)", timings: "12:20 p.m." },
  ...
  junior: {
    reporting: [
      { "means-of-transport": "Private Cars/Conveyance", timings: "8:15 a.m." },
