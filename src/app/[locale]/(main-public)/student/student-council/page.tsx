    ...
    <ArticlePage linkType="student" selected={{ translationKey: "council" }}>
      ...
      <section className="space-y-8">
        <div className="space-y-2.5">
          ...
          <p>
            We are glad to announce the selected list of School Appointments for
            session 2022-23 Students{"'"} Council
          </p>
        </div>
        <div className="flex items-center justify-center gap-8 sm:justify-around">
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.headBoy}
            designation="Head Boy"
          />
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.headGirl}
            designation="Head Girl"
          />
        </div>
        <div className="grid grid-cols-2 justify-items-center gap-x-8 gap-y-4 xl:grid-cols-4">
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.viceHeadBoyI}
            designation="Vice Head Boy"
          />
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.viceHeadBoyII}
            designation="Vice Head Boy"
          />
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.viceHeadGirlI}
            designation="Vice Head Girl"
          />
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.viceHeadGirlII}
            designation="Vice Head Girl"
          />
        </div>
        <div className="flex items-center justify-center gap-8 sm:justify-around">
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.juniorHeadBoy}
            designation="Junior Head Boy"
          />
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.juniorHeadGirl}
            designation="Junior Head Girl"
          />
        </div>
        <div className="grid grid-cols-2 justify-items-center gap-x-8 gap-y-4 xl:grid-cols-4">
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.sportsCaptainI}
            designation="Sports Captain"
          />
          <StudentCard
            {...studentCouncil["2022-23"].schoolAppointments.sportsCaptainII}
            designation="Sports Captain"
          />
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-8">
          <StaticTable
            ...
            headerRow={{
              cells: [{ text: "" }, { text: "Name" }, { text: "Grade" }],
            }}
            dataRows={Object.entries(housePrefects.kautilya)
              .map(([grade, students]) => [
                {
                  cells: [
                    { text: grade, rowSpan: students.length },
