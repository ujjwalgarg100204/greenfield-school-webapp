  ...
  return (
    <ArticlePage linkType="parent" selected={{ translationKey: "hours" }}>
      ...
      <p>
        ...
        teachers. Parents are advised to meet the Principal, the Administrator
        or the teachers according to the schedule given below after taking prior
        appointments. All appointments should be routed through the school
        diary.
      </p>
      <StaticTable
      ...
      <StaticTable
        caption={{
          title:
            "Vice Principal/Head Master/ Headmistress/ Coordinator Timings",
        }}
        headerRow={{ cells: [{ text: "Time" }, { text: "Days" }] }}
      ...
      <StaticTable
        ...
        headerRow={{ cells: [{ text: "Time" }, { text: "Days" }] }}
        dataRows={VISITING_HOURS_DATA["Teachers Class II - XII"].map(row => ({
          cells: [{ text: row.time }, { text: row.days }],
        }))}
      />
    </ArticlePage>
